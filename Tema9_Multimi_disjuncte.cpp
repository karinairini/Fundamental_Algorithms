/*
You are required to implement correctly and efficiently the base operations for disjoint set and the Kruskal’s algorithm 
(searching for the minimum spanning tree) using disjoint sets.
Requirements
- Correct implementation for: MAKE_SET, UNION and FIND_SET + demo
- Correct and efficient implementation for: Kruskal’s algorithm
- Evaluate the disjoint sets operations using Kruskal’s algorithm
*/
