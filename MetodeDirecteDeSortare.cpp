/*
Requirements
- Implement 1 direct sorting method, exemplify correctness and evaluate it in the average case
- Implement the other 2 sorting methods + demo + analysis in average case 
- Analysis in best and worst case
