/*
Requirements
- Implementation of iterative and recursive binary tree traversal + demo
- Comparative analysis of the recursive vs iterative tree traversal from the operations perspective
- Quicksort hybridization. Demo and comparative analysis from the operations and runtime perspective.
- Determination of an optimal threshold used in hybridisation + proof (graphics/measurements)
*/
