/*
You are required to implement correctly and efficiently the insert and search operations in a hash table using open addressing and 
quadratic probing.
Requirements
- Demo for the insert and search operations using the required data structure.
...
- Implement delete operation in a hash table. Demo and evaluation of the search operation after deletion of some elements.
*/
