/*
You are required to correctly and efficiently implement the depth first search algorithm (DFS). For graph representation, you should use 
adjacency lists. You also have to:
- Implement the Tarjan algorithm for detecting strongly connected components
- Implement topological sorting 
Requirements
- Correct and efficient implementation for DFS + demo
- Correct and efficient implementation for topological sort + demo
- Correct and efficient implementation for Tarjan + demo
- Analysis of the DFS performance + graphics
*/
