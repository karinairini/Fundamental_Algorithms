/*
You are required to implement correctly and efficiently an O(nlogk) method for merging k sorted sequences, where n is the total number 
of elements. 
...
- Evaluation of the algorithm in average case, interpretations
*/
